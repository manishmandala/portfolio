...
render_page(
    ...
    build_media='<img src="assets/lock-exploded-bom.png" alt="Combination lock exploded assembly and bill of materials">',
    build_caption="Fig. 1. Exploded assembly, 16 parts, one bill of materials.",
